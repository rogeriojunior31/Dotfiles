...
###
### My qtile config. Not much to see here; just some pretty standard stuff.
...
keys = [
        ...
        Key(["control", "shift"], "n", lazy.spawn("nautilus"), desc="Nautilus"),
        
        ### My Browsers
        
        Key([mod], "b", lazy.spawn(myBrowser), desc='Brave Browser'),
        Key(["control", "shift"], "b", lazy.spawn(myBrowser2), desc='QuteBrowser'),
        Key([mod, "control"], "c", lazy.spawn("luakit"), desc='Luakit'),
        Key([mod], "c", lazy.spawn("google-chrome-stable"), desc='Google Chrome'),

        ### My editors

        Key(["control", "shift"], "e", lazy.spawn("emacsclient -c -a emacs"), desc='Doom Emacs'),
        Key([mod, "shift"], "v", lazy.spawn("code -r"), desc='Visual Studio Code'),
        Key(["control", "shift"], "f", lazy.spawn(myTerm+" -e nvim"), desc='Nvim'),
        ...
        Key([mod], 'm', lazy.layout.maximize(), desc='toggle window between minumum and maximum sizes'),
...
groups = [Group("CHAT", layout='monadtall'),
...
def init_widgets_list():
    widgets_list = [
             ...
             widget.TextBox(
                      ...
                      foreground = colors[2],
                      background = colors[0],
                      mouse_callbacks = {'Button1': lambda: qtile.cmd_spawn('xsensors')},
                      fontsize = 14  
                     ),
